...
- [x] Log out — Profile
- [x] Delete account (parent-gated, data removed)
...
- [x] Change / update parent email (re-verify)
...
- [ ] Share profile
- [x] Edit profile (name, nickname, age, avatar, favourite subject) — `/edit-profile`; password reset live; parent email change + delete PIN-gated
...
- [x] Daily streak counter (keep flame by finishing a daily check-in)
- [x] Week view (days hit / missed) — Home week dots + `/streak`
...
- [x] Parent email (verified) — shown; change + re-verify on `/parent-email`
- [x] Delete account
...
- [x] Weekly report (XP, lessons, active days, charts)
- [x] Email weekly report to parent (e.g. Monday / Sunday)
- [x] Full report (longer charts)
- [x] Monthly goals (parent-set targets, % complete, XP/day) — system month goals live on `/monthly-goals`; parent custom targets later
- [x] Export progress / all data as PDF
- [x] Parent tips
